 ...
 _________________________________________________________ -->
            <div id="hot">
                ...
                <div class="box">
                    <div class="container">
                        <div class="col-md-12">
                            <h2>Danh sach cac san pham cua hang Sunshine</h2>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p>
                                    <ngcart-addtocart template-url="{{ asset('vendor/ngCart/template/ngCart/addtocart.html') }}" id="{{ $sanpham->sp_ma }}" name="{{ $sanpham->sp_ten }}" price="{{ $sanpham->sp_giaBan }}" quantity="1" quantity-max="5">Them vao gio hang</ngcart-addtocart>
                                    </p>
                                </div>
                                <!-- /.text -->
                            </div>
